...
<head>
    ...
    <style>
        ...
        h2 { color: #ffffff; border-bottom: 2px solid #0d6efd; padding-bottom: 10px; }
        
        .card { background-color: #1e1e1e; border: 1px solid #444; }
        
        /* Inputs */
        .form-control { background-color: #2b2b2b; color: #e0e0e0; border: 1px solid #555; }
        .form-control:focus { background-color: #333; color: #e0e0e0; border-color: #0d6efd; box-shadow: 0 0 0 0.25rem rgba(13, 110, 253, 0.25); }
        ...
        .btn-secondary { background-color: #4a67ff; border: none; }
    </style>
</head>
<body>
    <div class="container">
        <div class="row">
            <div class="col-md-8 offset-md-2">
                ...
                <form method="post" action="atualizar.php" enctype="multipart/form-data">
                    ...
                    <div class="mt-3 p-3" style="border: 1px solid #555; border-radius: 5px; background-color: #1e1e1e;">
                        <h5 class="text-white mb-3" style="border-bottom: 1px solid #444; padding-bottom: 5px;">Gerenciar Arquivo de Imagem</h5>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text text-white-50">Alterar este campo mudará o nome do arquivo na pasta e no banco.</div>
                        </div>
                    ...
                    <div class="mt-3 form-floating">
                        <input type="text" class="form-control" id="especificacoes" name="especificacoes" value="<?php echo htmlspecialchars($produto['especificacoes']); ?>">
